...
Following the methodology discussed in the module, the analysis was broken down into a series of quantitative measurements. By converting the floor plan into a topological grid and subsequently into an analysis graph, we can evaluate the building's performance in terms of movement and accessibility.
...
By identifying dense clusters of nodes, the algorithm computationally recognizes individual rooms and functional zones from a unified floor plan surface. Once partitioned, we computed **Degree Centrality** on the resulting spatial clusters to determine local "connectivity". This successfully maps the "popularity" of rooms, distinguishing highly central gathering hubs from secluded, private exhibition fringes.
